              ...
              <article className="bg-white rounded-lg sm:rounded-xl shadow-lg overflow-hidden border border-gray-200">
                ...
                <div className="p-4 sm:p-5 md:p-6">
                  <div className="flex flex-wrap gap-2 mb-4">
                    <span className="px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full text-xs sm:text-sm font-medium bg-emerald-100 text-emerald-800 flex items-center">
                      <Calendar className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5" />
                      Event
                    </span>
                    <span className={`px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full text-xs sm:text-sm font-medium ${eventStatus.color}`}>
                      {eventStatus.status.charAt(0).toUpperCase() + eventStatus.status.slice(1)}
                    </span>
                  </div>

                  <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-900 mb-4 sm:mb-5 leading-tight">
                    {event?.title}
                  </h1>
                  ...
                  <div className="mb-5">
                    <div className="flex items-center text-gray-700 bg-gray-50 rounded-lg p-3">
                      <div className="w-9 h-9 bg-emerald-100 rounded-lg flex items-center justify-center mr-3 flex-shrink-0">
                        <Calendar className="w-4 h-4 sm:w-5 sm:h-5 text-emerald-600" />
                      </div>
                      <div>
                        <p className="text-xs text-gray-500 mb-0.5">Date</p>
                        <p className="text-sm sm:text-base font-medium text-gray-900">{formatEventDate(event?.start_date || '', event?.end_date)}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-wrap gap-2 mb-5 pb-5 border-b border-gray-200">
                    ...
                    >
                      <Heart className={`w-3 h-3 sm:w-4 sm:h-4 mr-1.5 ${isLiked ? 'fill-current' : ''}`} />
                    ...
                    <div className="relative">
                      <button
                        onClick={() => handleShare()}
                        className="flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-emerald-100 text-emerald-700 rounded-lg text-xs sm:text-sm font-medium hover:bg-emerald-200 transition-all duration-200"
                      >
                    ...
                    <button
                      onClick={handlePrint}
                      className="flex items-center px-3 sm:px-4 py-1.5 sm:py-2 bg-gray-100 text-gray-700 rounded-lg text-xs sm:text-sm font-medium hover:bg-gray-200 transition-all duration-200"
                    >
                  ...
                  <div className="prose prose-sm sm:prose-base max-w-none">
                    <h2 className="text-lg sm:text-xl font-bold text-gray-900 mb-3">About This Event</h2>
                    {event?.description ? (
