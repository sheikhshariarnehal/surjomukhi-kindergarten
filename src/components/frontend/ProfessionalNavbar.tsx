            ...
            <div className="flex-shrink-0 min-w-0 flex-1 sm:flex-initial">
              ...
              >
                <div className="relative flex-shrink-0">
                  <div className="w-8 h-8 xs:w-9 xs:h-9 sm:w-9 sm:h-9 lg:w-10 lg:h-10 rounded-lg overflow-hidden shadow-md transition-all duration-300 group-hover:shadow-lg group-hover:scale-105 bg-white border border-gray-100">
                    <Image
                      src="/logo.webp"
                ...
                <div className="ml-1.5 xs:ml-2 sm:ml-2.5 min-w-0 flex-1 sm:flex-initial">
                  <div className="text-[11px] xs:text-xs sm:text-sm lg:text-base font-bold text-gray-900 transition-colors duration-300 group-hover:text-blue-600 leading-tight truncate">
                    {t('common.schoolName', 'Surjomukhi Kindergarten')}
                  </div>
                  <div className="text-[9px] xs:text-[10px] sm:text-[10px] lg:text-xs text-gray-600 font-medium leading-tight block truncate mt-0.5">
...
const SocialIcon: React.FC<SocialIconProps> = React.memo(({ platform }) => {
  ...
  return (
    <svg className="w-2.5 h-2.5 xs:w-3 xs:h-3 lg:w-3.5 lg:h-3.5 transition-all duration-300 group-hover:scale-110 group-hover:brightness-125" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
      <path d={path} />
    </svg>
  );
});
